...
describe('Task 1.a CRUD', function() {
    ...
    describe('/videos REST API POST', function() {
        ...
        // bad POSTs
        it('should detect a post to wrong URL (/videos/:id) and answer with code 405', function(done) {
            request(videoURL)
                .post('/123')
                .set('Accept-Version', '1.0')
                .set('Accept', 'application/json')
    ...
    describe('/videos/:id REST API PUT', function() {
        ...
        // bad PUTs
        it('should detect a PUT to wrong URL (/videos/ without id) and answer with code 405', function(done) {
            request(videoURL)
                .put('/')
                .set('Accept-Version', '1.0')
                .set('Accept', 'application/json')
